class PriceList {
  ...
  setEmojiDefault() {
    ...
    const defaultEmojis = [
      ...
      { x:  6, y: 56, category: 'food', label: 'roasted sweet potato', },
      { x:  6, y: 14, category: 'food', label: 'hot pepper', },
      { x:  6, y: 30, category: 'food', label: 'eggplant', },
      { x: 42, y:  2, category: 'food', label: 'leafy green', },

      { x:  7, y: 21, category: 'food', label: 'glass of milk', },
      { x: 44, y:  8, category: 'food', label: 'cheese wedge', },
      { x: 44, y: 16, category: 'food', label: 'butter', },
  //	{ x:  7, y: 18, category: 'food', label: 'fried egg', },
      { x: 55, y: 53, category: 'food', label: 'egg', },

      { x:  6, y: 54, category: 'food', label: 'bread', },
      { x:  6, y: 22, category: 'food', label: 'sheaf of rice', },
      { x:  6, y: 21, category: 'food', label: 'ear of corn', },
  //	{ x:  7, y: 30, category: 'food', label: 'popcorn', },
      ...
      { x:  6, y: 34, category: 'food', label: 'tangerine', },
      ...
      { x:  6, y: 32, category: 'food', label: 'melon', },
      { x:  6, y: 41, category: 'food', label: 'peach', },
      { x:  6, y: 42, category: 'food', label: 'cherries', },
      { x:  6, y: 43, category: 'food', label: 'strawberry', },

      { x:  6, y: 47, category: 'food', label: 'bacon', },
      { x:  6, y: 46, category: 'food', label: 'cut of meat', },
      { x:  6, y: 46, category: 'food', label: 'meat on bone', },
      { x:  6, y: 47, category: 'food', label: 'poultry leg', },
      { x:  7, y:  3, category: 'food', label: 'shrimp', },

      { x:  7, y: 15, category: 'food', label: 'moon cake', },
      ...
      { x:  7, y: 14, category: 'food', label: 'honey pot', },

      { x: 44, y: 18, category: 'food', label: 'ice', },
      { x: 44, y: 17, category: 'food', label: 'mate', },
      { x:  7, y: 20, category: 'food', label: 'teacup without handle', },
      { x: 53, y:  0, category: 'food', label: 'hot beverage', },
      { x:  7, y: 25, category: 'food', label: 'beer mug', },
      { x:  7, y: 22, category: 'food', label: 'clinking glasses', },
      { x:  7, y: 29, category: 'food', label: 'bottle with popping cork', },
      { x: 44, y: 11, category: 'food', label: 'beverage box', },
      { x:  7, y: 27, category: 'food', label: 'baby bottle', },

      { x: 44, y: 10, category: 'food', label: 'salt', },
      { x: 42, y:  1, category: 'food', label: 'canned food', },
      { x: 51, y: 39, category: 'food', label: 'lotion bottle', },

      { x:  7, y: 17, category: 'food', label: 'pot of food', },
      { x:  6, y: 45, category: 'food', label: 'pizza', },
      { x: 42, y:  0, category: 'food', label: 'sandwich', },
      { x:  6, y: 44, category: 'food', label: 'hamburger', },
      { x:  6, y:  5, category: 'food', label: 'hot dog', },
      { x:  6, y:  6, category: 'food', label: 'taco', },
      { x:  6, y:  7, category: 'food', label: 'burrito', },

      { x:  5, y: 21, category: 'household', label: 'umbrella', },
      { x: 52, y: 51, category: 'household', label: 'umbrella with rain drops', },
      { x:  7, y: 19, category: 'household', label: 'fork and knife', },
      { x:  7, y: 28, category: 'household', label: 'fork and knife with plate', },
      { x:  7, y: 32, category: 'household', label: 'wrapped gift', },
      { x:  7, y: 44, category: 'household', label: 'balloon', },
      { x:  7, y: 54, category: 'household', label: 'backpack', },
      { x: 51, y: 43, category: 'household', label: 'teddy bear', },
      { x: 51, y: 44, category: 'household', label: 'broom', },
      { x: 51, y: 46, category: 'household', label: 'roll of paper', },
      { x: 51, y: 47, category: 'household', label: 'soap', },
      { x: 51, y: 48, category: 'household', label: 'sponge', },
      { x: 52, y:  5, category: 'household', label: 'chair', },
      { x:  6, y:  9, category: 'plant', label: 'seedling', },
      { x:  6, y: 10, category: 'plant', label: 'evergreen tree', },
      { x:  6, y: 11, category: 'plant', label: 'deciduous tree', },
      { x:  6, y: 12, category: 'plant', label: 'palm tree', },
      { x:  6, y: 13, category: 'plant', label: 'cactus', },
      { x:  6, y: 15, category: 'plant', label: 'tulip', },
      { x:  6, y: 16, category: 'plant', label: 'rosette', },
      { x:  6, y: 17, category: 'plant', label: 'rose', },
      { x:  6, y: 18, category: 'plant', label: 'blossom', },
      { x:  6, y: 19, category: 'plant', label: 'sunflower', },
      { x:  6, y: 20, category: 'plant', label: 'cherry blossom', },
      // { x:  6, y: 23, category: 'plant', label: 'leaves', },
      { x:  8, y:  1, category: 'tech', label: 'microphone', },
      { x:  8, y: 10, category: 'tech', label: 'studio microphone', },
      { x:  8, y: 13, category: 'tech', label: 'headphone', },
      ...
      { x: 14, y:  8, category: 'clothing', label: 'necktie', },
      { x: 14, y:  9, category: 'clothing', label: 'tshirt', },
      { x: 14, y: 10, category: 'clothing', label: 'jeans', },
      { x: 14, y: 11, category: 'clothing', label: 'dress', },
      { x: 14, y: 14, category: 'clothing', label: 'womans clothes', },
      { x: 14, y: 22, category: 'clothing', label: 'thong sandal', },
      { x: 14, y: 18, category: 'clothing', label: 'mans shoe', },
      { x: 14, y: 18, category: 'clothing', label: 'hiking boot', },
      { x: 14, y: 19, category: 'clothing', label: 'running shoe', },
      { x: 14, y: 20, category: 'clothing', label: 'flat shoe', },
      { x: 14, y: 21, category: 'clothing', label: 'womans sandal', },
      { x: 14, y: 23, category: 'clothing', label: 'womans boot', },
      { x: 14, y:  6, category: 'clothing', label: 'womans hat', },
      { x: 51, y: 21, category: 'clothing', label: 'billed cap', },
      { x: 51, y: 21, category: 'clothing', label: 'top hat', },
      ...
      { x: 25, y: 18, category: 'category', label: 'barber pole', },
